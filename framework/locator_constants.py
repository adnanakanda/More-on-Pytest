...
to use the locator constants you need to use this

from locator_constants import Locator_Constants

# Using constants
precise_locator = Locator_Constants.PRECISE_TEXT_LOCATOR.format("some_text")
partial_locator = Locator_Constants.PARTIAL_TEXT_LOCATOR.format("partial_text")"""
