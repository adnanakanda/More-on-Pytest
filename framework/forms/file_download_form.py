...
class FileDownloadForm(BaseForm):
    ...
    __pdf_title = PyQualityServices.element_factory.get_label((By.XPATH,("//div[contains(@class, 'mw-electronpdfservice-selection-label-desc')]")),"File name")
    ...
    def __init__(self):
        super(FileDownloadForm, self).__init__((By.XPATH, LocatorConstant.PRECISE_TEXT_LOCATOR.format(self.__page_name)), self.__page_name)
